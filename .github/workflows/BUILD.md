...
- **Linux** documentation has been archived. See `archive/linux_removed/` or `doc/LINUX_PACKAGING_REMOVED.md` for current policy.
...
Linux build workflows and documentation have been archived and removed from the active CI pipeline. If you require Linux packaging or build instructions, see `archive/linux_removed/` or `doc/LINUX_PACKAGING_REMOVED.md`.
...
- **Detailed Docs:**
  ...
  - Linux workflow documentation has been archived. See `archive/linux_removed/` or `doc/LINUX_PACKAGING_REMOVED.md` for details.
